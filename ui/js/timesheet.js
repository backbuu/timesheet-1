...
        if (request.readyState === 4 && request.status === 200) { 
        ...
        if (json !== null){
            for (var index = 0; index < json.length; index++) {
                companyIndex = parseInt(json[index].company);
            ...
                table[companyIndex] += "<td id=\"member_name_th_id_"+index+"\">"+json[index].member_name_th+"</td>";
        ...
                totalIncomeTax53[companyIndex] += json[index].income_tax_53;
            ...
                totalNetTransfer[companyIndex] += json[index].net_transfer;
                ...
                table[companyIndex] += "<input type=\"hidden\" id=\"member_id_"+index+"\" value=\""+json[index].member_id+"\">";
    ...
    request.onreadystatechange = function () {
        if (request.readyState === 4 && request.status === 200) {
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                member += "<tr><th>Company Name</th><td id=\"company_id_"+i+"\">"+json[i].company+"</td></tr>";
                member += "<tr><th>Name (Thai)</th><td id=\"member_name_th_id_"+i+"\">"+json[i].member_name_th+"</td></tr>";
                member += "<tr><th>Name (English)</th><td id=\"member_name_eng_id_"+i+"\">"+json[i].member_name_eng+"</td></tr>";
                ...
                member += "<tr><th>Salary</th><td><input type=\"number\" id=\"salary_id_"+i+"\" value=\""+json[i].salary.toFixed(2)+"\"></td></tr>";
                member += "<tr><th>Withholding Income Tax (P.N.D.1)</th><td><input type=\"number\" id=\"income_tax_1_id_"+i+"\" value=\""+json[i].income_tax_1.toFixed(2)+"\"></td></tr>";
                member += "<tr><th>Social Security Tax</th><td><input type=\"number\" id=\"social_security_id_"+i+"\" value=\""+json[i].social_security.toFixed(2)+"\"></td></tr>";
                member += "<tr><th>Withholding Income Tax Percentage (P.N.D.53)</th><td><input type=\"number\" id=\"income_tax_53_percentage_id_"+i+"\" value=\""+json[i].income_tax_53_percentage+"\"></td></tr>";
                member += "<tr><th>Type of Income</th><td><select id=\"status_id_"+i+"\">";
                ...
                member += "</select></td></tr>";
                member += "<tr><th>Travel Expenses</th><td><input type=\"number\" id=\"travel_expense_id_"+i+"\" value=\""+json[i].travel_expense.toFixed(2)+"\"></td></tr>";
                member += "<input type=\"hidden\" id=\"member_details_id_"+i+"\" value=\""+json[i].id+"\">";
                member += "<input type=\"hidden\" id=\"member_id_"+i+"\" value=\""+memberID+"\">";
                member += "<tr><td></td><td><input class=\"button\" type=\"submit\" id=\"button_edit_member_id_"+i+"\" value=\"EDIT\" onclick=\"editMemberDetails("+i+")\"></td></tr>";                                    
                member += "</table>"
                if (i+1 < json.length) {
                    member += "<br><br><br>"
                }
