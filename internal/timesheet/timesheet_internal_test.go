...
func Test_CalculateTotalSalaryInYearByEmployeeID_Input_TransactionTimesheetList_Should_Be_320000(t *testing.T) {
	expected := 320000.00
	transactionTimesheetList := []model.TransactionTimesheet{
		{
			ID:                     "00120171001",
	...
	actual := calculateTotalSalaryInYearByEmployeeID(transactionTimesheetList)

	assert.Equal(t, expected, actual)
}

func Test_CalculateTotalIncomeTax1InYearByEmployeeID_Input_TransactionTimesheetList_Should_Be_20000(t *testing.T) {
	expected := 20000.00
	transactionTimesheetList := []model.TransactionTimesheet{
		{
			ID:                     "00120171001",
	...
	actual := calculateTotalIncomeTax1InYearByEmployeeID(transactionTimesheetList)

	assert.Equal(t, expected, actual)
}

func Test_CalculateTotalSocialSecurityInYearByEmployeeID_Input_TransactionTimesheetList_Should_Be_0(t *testing.T) {
	expected := 0.00
	transactionTimesheetList := []model.TransactionTimesheet{
		{
			ID:                     "00120171001",
	...
	actual := calculateTotalSocialSecurityInYearByEmployeeID(transactionTimesheetList)

	assert.Equal(t, expected, actual)
}

func Test_CalculateTotalNetSalaryInYearByEmployeeID_Input_TransactionTimesheetList_Should_Be_300000(t *testing.T) {
	expected := 300000.00
	transactionTimesheetList := []model.TransactionTimesheet{
		{
			ID:                     "00120171001",
	...
	actual := calculateTotalNetSalaryInYearByEmployeeID(transactionTimesheetList)

	assert.Equal(t, expected, actual)
}

func Test_CalculateTotalWageInYearByEmployeeID_Input_TransactionTimesheetList_Should_Be_300000(t *testing.T) {
	expected := 300000.00
	transactionTimesheetList := []model.TransactionTimesheet{
		{
			ID:                     "00120171001",
	...
	actual := calculateTotalWageInYearByEmployeeID(transactionTimesheetList)

	assert.Equal(t, expected, actual)
}

func Test_CalculateTotalIncomeTax53InYearByEmployeeID_Input_TransactionTimesheetList_Should_Be_30000(t *testing.T) {
	expected := 30000.00
	transactionTimesheetList := []model.TransactionTimesheet{
		{
			ID:                     "00120171001",
	...
	actual := calculateTotalIncomeTax53InYearByEmployeeID(transactionTimesheetList)

	assert.Equal(t, expected, actual)
}

func Test_CalculateTotalNetWageInYearByEmployeeID_Input_TransactionTimesheetList_Should_Be_270000(t *testing.T) {
	expected := 270000.00
	transactionTimesheetList := []model.TransactionTimesheet{
		{
			ID:                     "00120171001",
	...
	actual := calculateTotalNetWageInYearByEmployeeID(transactionTimesheetList)

	assert.Equal(t, expected, actual)
}

func Test_CalculateTotalNetTransferInYearByEmployeeID_Input_TransactionTimesheetList_Should_Be_570000(t *testing.T) {
	expected := 570000.00
	transactionTimesheetList := []model.TransactionTimesheet{
		{
			ID:                     "00120171001",
	...
	actual := calculateTotalNetTransferInYearByEmployeeID(transactionTimesheetList)
